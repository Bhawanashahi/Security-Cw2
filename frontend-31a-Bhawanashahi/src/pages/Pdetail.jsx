...
import { getSinglePhotoApi } from "../apis/Api";
import '../style/pdetail.css';
...
const PhotographyDetail = () => {
  ...
  useEffect(() => {
    const fetchPhoto = async () => {
      try {
        const response = await getSinglePhotoApi(id);
        if (response.data) {
  ...
  const bookedDates = ['2024-07-22', '2024-07-17'];
      ...
      <div className="container mt-5">
        <div className="row">
          ...
          <div className="col-md-6">
            ...
            <Button variant="primary" className="book-now" onClick={handleBookNowClick}>
              Book Now
            </Button>
          </div>
        </div>
        ...
        <div className="reviews-section mt-5">
              <Button variant="link" onClick={handleWriteReviewClick} style={{marginLeft:'1030px'}}>Write Review</Button>
          <h4>REVIEWS</h4>
        ...
        <div className="review">
          ...
          <p>I really like your services.</p>
        </div>
        </div> 
