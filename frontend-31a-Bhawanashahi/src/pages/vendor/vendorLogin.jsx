...
import {loginVendorUserApi } from "../../apis/Api";
...
const VendorLogin = () => {
    ...
    const handleSubmit = (e) => {
        ...
        loginVendorUserApi(data).then((res) => {
      ...
      <Row className="w-100">
        ...
        <Col md={6} className="p-5 d-flex flex-column justify-content-center">
          ...
          <Form className="mb-0">
           ...
           <Form.Text className="text-muted mt-2" style={{ fontSize: '15px', color: 'black', marginLeft: '400px', fontStyle: 'italic', fontSize: '10px', marginTop:'100px'}}>
